        ...
        data() {
            return {
                ...
                formInputs1:[
                    ...
                    {label:'费用类型',prop:'cpType',dict:'ZDCLK0064',span:6},
                    {label:'费用总金额',prop:'cpJl',append:'元',span:6,handler:(o)=>{
                            return parseFloat(o/100);
                        }},
                    {label:'是否分佣',prop:'cpYj',dict:'ZDCLK0064',span:6},
                    {label:'一级佣金',prop:'cpYjyj',append:'元',span:6,handler:(o)=>{
                            return parseFloat(o/100);
                        }},
                    {label:'二级佣金',prop:'cpRjyj',append:'元',span:6,handler:(o)=>{
                            return parseFloat(o/100);
                        }},
                ],
                ruleInline:{
