...
//    //微信统一下单接口生成orderId
//    @RequestMapping(method={RequestMethod.POST}, value = "/wxPayOrder")
//    @ResponseBody
//    public String wxPayOrder(@RequestParam("body")String json, HttpServletRequest request) throws Exception{
//        HtmlMessage result = new HtmlMessage();
//        ObjectMapper mapper = new ObjectMapper();
//        Map<String, String> payParam = mapper.readValue(json, Map.class);
//        //缴费类型。报名还是补考。1报名；2补考。
//        String costType = payParam.get("costType");
//        //生成订单信息
//        //调用微信统一下单接口获取下单认证码
//        SortedMap<String, String> signParams = new TreeMap<String, String>();
//        signParams.put("appid", Constant.WXAPPID);
//        signParams.put("body", "课程收费");
//        signParams.put("attach", payParam.get("serId"));
//        signParams.put("mch_id", Constant.WXMECID);
//        signParams.put("nonce_str", Sha1Util.getNonceStr());
//        signParams.put("notify_url", Constant.WEB_NOTITY);
//        signParams.put("openid", payParam.get("openid"));
//        String tradeNo = DateUtils.getToday("yyyyMMddHH") + RandomStringUtils.randomAlphanumeric(22);
//        signParams.put("out_trade_no", tradeNo);
//        //发起订单的IP
//        signParams.put("spbill_create_ip", payParam.get("ip"));
//        //支付金额
//        if ("2".equals(costType)){
//            //补考现在默认150
//            signParams.put("total_fee", "15000");
//        }else{
//            signParams.put("total_fee", payParam.get("totalPrice")+"00");
//        }
//
//        //测试金额，1分钱
...
//
//        String id = WxAccessUtil.unifiedorder(signParams);
//        log.debug("订单生成信息，交易ID["+id+"]，交易信息["+mapper.writeValueAsString(signParams)+"]");
//        if (StringUtils.isNotEmpty(id)){
//            Map<String, String> mapData = new HashMap<String, String>();
//            mapData.put("prepay_id", id);
//            mapData.put("tradeNo", tradeNo);
//
//            signParams.clear();
//            signParams.put("appId", Constant.WXAPPID);
//            signParams.put("timeStamp", String.valueOf(new Date().getTime()));
//            signParams.put("nonceStr", Sha1Util.getNonceStr());
//            signParams.put("package", "prepay_id="+id);
//            signParams.put("signType", "MD5");
//            String paySign = Sha1Util.createMD5Sign(signParams);
//            mapData.putAll(signParams);
//            mapData.put("paySign", paySign);
//            result.setEntity(mapData);
//        }else{
//            result.setStatusCode(HtmlMessage.STATUS_CODE_FAILURE);
//            result.setMessage("未成功生成预授权ID，请重试！");
//        }
//
//        return result;
//    }
