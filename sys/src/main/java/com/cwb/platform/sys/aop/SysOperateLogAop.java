package com.cwb.platform.sys.aop;
...
public class SysOperateLogAop {
    ...
    @Around("execution(public * com.cwb.platform.sys..*.*Controller.save*(..))" +
            "|| execution(public * com.cwb.platform.sys..*.*Controller.update*(..))" +
            "|| execution(public * com.cwb.platform.sys..*.*Controller.remove*(..))"+
            "|| execution(public * com.cwb.platform.sys..*.*Ctrl.save*(..))" +
            "|| execution(public * com.cwb.platform.sys..*.*Ctrl.update*(..))" +
            "|| execution(public * com.cwb.platform.sys..*.*Ctrl.remove*(..))"
    )
