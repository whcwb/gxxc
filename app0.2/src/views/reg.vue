...
<template>
  <div id="reg" class="box_col" style="background-image:url('static/reg/regBack.png') ">
    ...
    <div class="box_col_100" style="padding: 0.3rem">
      ...
      <div style="height: 0.5rem" @click="regShow = !regShow">
        <el-checkbox v-model="checked" disabled>
          <span style="color: #f2f2f2">
            我已阅读并同意《<span style="color: red">注册协议</span>》
          </span>
        </el-checkbox>
      </div>
    ...
    <div class="regMess" v-show="regShow">
      <div class="regnk box_col">
        <div style="text-align: center;position: relative">
          <h3 style="color: #f75d42">新用户注册协议</h3>
          <i class="iconfont icon-close"
             @click="regShow = !regShow"
              style="position: absolute; top:0.05rem;right: 0.05rem;color: #b1b1b1;font-size: 0.25rem;"></i>
        </div>
        <div class="box_col_auto" style="padding: 0 0.15rem;">
          <div class="fontsty">
            用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与520学车联盟之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。
          </div>
          <div>
            <h5>一、协议声明</h5>
            <div class="fontsty">
              1.1 本协议则可由武汉天弘腾创科技有限公司随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分
            </div>
          </div>
          <div>
            <h5>二、服务内容</h5>
            <div class="fontsty">
              2.1 武汉天弘腾创科技有限公司的具体内容由本站根据实际情况提供。
            </div>
            <div class="fontsty">
          ...
          <div>
            <h5>三、用户帐号</h5>
            <div class="fontsty">
              3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。武汉天弘腾创科技有限公司有权对会员的权限设计进行变更。
            </div>
            <div class="fontsty">
          ...
          <div>
            ...
            <div class="fontsty">
              6.3 使用本站的任何内容均应注明“来源于武汉天弘腾创科技有限公司”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。
            </div>
            <div class="fontsty">
          ...
          <div>
            <h5>七、责任声明</h5>
            <div class="fontsty">
              7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，武汉天弘腾创科技有限公司对此不承担任何责任。
            </div>
            <div class="fontsty">
