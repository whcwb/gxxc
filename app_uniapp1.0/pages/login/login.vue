<template>
	<view style="width: 100%;padding-top: 1upx;background: rgba(255,255,255,1);">
		...
		<view class="inputMess">
			<input class="uni-input input" style="font-size: 16px;height: 40px;margin: 10px 20rpx;" placeholder="请输入手机号" v-model="form.username" />
			<input class="uni-input input" style="font-size: 16px;height: 40px;margin: 10px 20rpx;" password placeholder="请输入密码" v-model="form.password" />
		</view>
